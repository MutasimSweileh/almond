...
// PHPMaker 6 configuration for Table clients
$clients = NULL; // Initialize table object
...
class cclients {
	...
	function cclients() {
		...
		$this->id = new cField('clients', 'x_id', 'id', "`id`", 3, -1, FALSE);
		$this->fields['id'] =& $this->id;
		$this->image = new cField('clients', 'x_image', 'image', "`image`", 201, -1, TRUE);
		$this->fields['image'] =& $this->image;
		$this->order = new cField('clients', 'x_order', 'order', "`order`", 3, -1, FALSE);
		$this->fields['order'] =& $this->order;
		$this->active = new cField('clients', 'x_active', 'active', "`active`", 3, -1, FALSE);
