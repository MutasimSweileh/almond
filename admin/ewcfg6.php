...
define("EW_CONN_USER", "antiblin_almond", TRUE);
define("EW_CONN_PASS", "(W5vGq0w8KY4", TRUE);
define("EW_CONN_DB", "antiblin_almond", TRUE);
...
define("EW_PROJECT_NAME", "almond", TRUE); // Project Name
define("EW_RANDOM_KEY", '2ZdWZ8yFr50nZrWz', TRUE); // Random key for encryption
...
define("EW_SENDER_EMAIL", "amr@erasoft-eg.com", TRUE); // Sender email
