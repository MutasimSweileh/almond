...
<html>
<head>
	<title>Welcome to Almond website admin</title>
<?php if (@$gsExport == "") { ?>
<link rel="stylesheet" type="text/css" href="http://yui.yahooapis.com/2.6.0/build/container/assets/skins/sam/container.css">
<?php } ?>
<?php if (@$gsExport == "" || @$gsExport == "print") { ?>
<link rel="stylesheet" type="text/css" href="almond.css">
<?php } ?>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
<meta name="generator" content="PHPMaker v6.1.0.2">
</head>
...
<?php include "ewmenu.php" ?>
	    ...
	    <td class="ewContentColumn">
			<!-- right column (begin) -->
				<p class="phpmaker"><b>Welcome to Almond website admin</b></p>
	<?php } ?>
