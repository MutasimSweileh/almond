...
products_edit.ShowHighlightText = "Show highlight"; 
products_edit.HideHighlightText = "Hide highlight";
...
<p><span class="phpmaker">Edit TABLE: products<br><br>
...
<?php if ($products->id->Visible) { // id ?>
	<tr<?php echo $products->id->RowAttributes ?>>
		...
		<td<?php echo $products->id->CellAttributes() ?>><span id="el_id">
<div<?php echo $products->id->ViewAttributes() ?>><?php echo $products->id->EditValue ?></div><input type="hidden" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($products->id->CurrentValue) ?>">
</span><?php echo $products->id->CustomMsg ?></td>
	</tr>
<?php } ?>
...
<p>
<input type="button" name="btnAction" id="btnAction" value="   Edit   " onclick="ew_SubmitForm(products_edit, this.form);">
</form>
<script type="text/javascript">
<!--
