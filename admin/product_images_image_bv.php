...
// Define page object
$product_images_image_blobview = new cproduct_images_image_blobview();
$Page =& $product_images_image_blobview;

// Page init processing
$product_images_image_blobview->Page_Init();

// Page main processing
$product_images_image_blobview->Page_Main();
?>
<?php
$product_images_image_blobview->Page_Terminate();
?>
<?php
...
// Page Class
//
class cproduct_images_image_blobview {

	// Page ID
	var $PageID = 'blobview';

	// Page Object Name
	var $PageObjName = 'product_images_image_blobview';
	...
	//  - open connection
	//
	function cproduct_images_image_blobview() {
		global $conn;
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('product_images', 'x_image');
