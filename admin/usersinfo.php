...
class cusers {
	...
	function cusers() {
		...
		$this->id = new cField('users', 'x_id', 'id', "`id`", 3, -1, FALSE);
		$this->fields['id'] =& $this->id;
		$this->username = new cField('users', 'x_username', 'username', "`username`", 200, -1, FALSE);
		$this->fields['username'] =& $this->username;
		$this->password = new cField('users', 'x_password', 'password', "`password`", 200, -1, FALSE);
		$this->fields['password'] =& $this->password;
		$this->zemail = new cField('users', 'x_zemail', 'email', "`email`", 200, -1, FALSE);
