...
// Define page object
$gallery_image_blobview = new cgallery_image_blobview();
$Page =& $gallery_image_blobview;

// Page init processing
$gallery_image_blobview->Page_Init();

// Page main processing
$gallery_image_blobview->Page_Main();
?>
<?php
$gallery_image_blobview->Page_Terminate();
?>
<?php
...
// Page Class
//
class cgallery_image_blobview {

	// Page ID
	var $PageID = 'blobview';

	// Page Object Name
	var $PageObjName = 'gallery_image_blobview';
	...
	//  - open connection
	//
	function cgallery_image_blobview() {
		global $conn;
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('gallery', 'x_image');
