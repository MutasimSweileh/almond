...
class cdefault {
	...
	function Page_Main() {
		...
		if ($Security->IsLoggedIn()) {
			$this->Page_Terminate("about_itemlist.php");
		}
		if ($Security->IsLoggedIn()) {
		...
		if ($Security->IsLoggedIn()) {
			$this->Page_Terminate("gallerylist.php");
		}
		if ($Security->IsLoggedIn()) {
			$this->Page_Terminate("info_medialist.php");
		}
		if ($Security->IsLoggedIn()) {
			$this->Page_Terminate("product_imageslist.php");
		}
		if ($Security->IsLoggedIn()) {
			$this->Page_Terminate("product_videoslist.php");
		}
		if ($Security->IsLoggedIn()) {
			$this->Page_Terminate("searchenginelist.php");
		}
		if ($Security->IsLoggedIn()) {
			$this->Page_Terminate("sliderlist.php");
		}
		if ($Security->IsLoggedIn()) {
			$this->Page_Terminate("staticlist.php");
		}
		if ($Security->IsLoggedIn()) {
			$this->Page_Terminate("userslist.php");
		}
		if ($Security->IsLoggedIn()) {
			$this->Page_Terminate("visitorslist.php");
		}
		if ($Security->IsLoggedIn()) {
