...
// Define page object
$about_item_edit = new cabout_item_edit();
$Page =& $about_item_edit;

// Page init processing
$about_item_edit->Page_Init();

// Page main processing
$about_item_edit->Page_Main();
?>
...
// Create page object
var about_item_edit = new ew_Page("about_item_edit");

// page properties
about_item_edit.PageID = "edit"; // page ID
var EW_PAGE_ID = about_item_edit.PageID; // for backward compatibility

// extend page with ValidateForm function
about_item_edit.ValidateForm = function(fobj) {
...
about_item_edit.Form_CustomValidate =  
 function(fobj) { // DO NOT CHANGE THIS LINE!

 	// Your custom validation code here, return false if invalid. 
 	return true;
 }
about_item_edit.SelectAllKey = function(elem) {
	ew_SelectAll(elem);
}
<?php if (EW_CLIENT_VALIDATE) { ?>
about_item_edit.ValidateRequired = true; // uses JavaScript validation
<?php } else { ?>
about_item_edit.ValidateRequired = false; // no JavaScript validation
<?php } ?>

// search highlight properties
about_item_edit.ShowHighlightText = "Show highlight"; 
about_item_edit.HideHighlightText = "Hide highlight";
...
<p><span class="phpmaker">Edit TABLE: about item<br><br>
<a href="<?php echo $about_item->getReturnUrl() ?>">Go Back</a></span></p>
<?php $about_item_edit->ShowMessage() ?>
<form name="fabout_itemedit" id="fabout_itemedit" action="<?php echo ew_CurrentPage() ?>" method="post" onsubmit="return about_item_edit.ValidateForm(this);">
<p>
<input type="hidden" name="a_table" id="a_table" value="about_item">
...
<?php if ($about_item->id->Visible) { // id ?>
	<tr<?php echo $about_item->id->RowAttributes ?>>
		...
		<td<?php echo $about_item->id->CellAttributes() ?>><span id="el_id">
<div<?php echo $about_item->id->ViewAttributes() ?>><?php echo $about_item->id->EditValue ?></div><input type="hidden" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($about_item->id->CurrentValue) ?>">
</span><?php echo $about_item->id->CustomMsg ?></td>
	</tr>
<?php } ?>
...
<?php
$about_item_edit->Page_Terminate();
?>
<?php
...
class cabout_item_edit {
	...
	// Page Object Name
	var $PageObjName = 'about_item_edit';
	...
	function Page_Main() {
		...
		if (@$_POST["a_edit"] <> "") {
			$about_item->CurrentAction = $_POST["a_edit"]; // Get action code
			$this->LoadFormValues(); // Get form values

			// Validate Form
			if (!$this->ValidateForm()) {
				$about_item->CurrentAction = ""; // Form error, reset action
				$this->setMessage($gsFormError);
				$this->RestoreFormValues();
			}
		} else {
			$about_item->CurrentAction = "I"; // Default action is display
		}

		// Check if valid key
		if ($about_item->id->CurrentValue == "")
			$this->Page_Terminate("about_itemlist.php"); // Invalid key, return to list
		...
		// Render the record
		$about_item->RowType = EW_ROWTYPE_EDIT; // Render as edit
		$this->RenderRow();
	}
