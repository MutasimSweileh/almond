...
// Define page object
$searchengine_edit = new csearchengine_edit();
$Page =& $searchengine_edit;

// Page init processing
$searchengine_edit->Page_Init();

// Page main processing
$searchengine_edit->Page_Main();
?>
...
// Create page object
var searchengine_edit = new ew_Page("searchengine_edit");

// page properties
searchengine_edit.PageID = "edit"; // page ID
var EW_PAGE_ID = searchengine_edit.PageID; // for backward compatibility

// extend page with ValidateForm function
searchengine_edit.ValidateForm = function(fobj) {
...
searchengine_edit.Form_CustomValidate =  
 function(fobj) { // DO NOT CHANGE THIS LINE!

 	// Your custom validation code here, return false if invalid. 
 	return true;
 }
searchengine_edit.SelectAllKey = function(elem) {
	ew_SelectAll(elem);
}
<?php if (EW_CLIENT_VALIDATE) { ?>
searchengine_edit.ValidateRequired = true; // uses JavaScript validation
<?php } else { ?>
searchengine_edit.ValidateRequired = false; // no JavaScript validation
<?php } ?>

// search highlight properties
searchengine_edit.ShowHighlightText = "Show highlight"; 
searchengine_edit.HideHighlightText = "Hide highlight";
...
<p><span class="phpmaker">Edit TABLE: searchengine<br><br>
<a href="<?php echo $searchengine->getReturnUrl() ?>">Go Back</a></span></p>
<?php $searchengine_edit->ShowMessage() ?>
<form name="fsearchengineedit" id="fsearchengineedit" action="<?php echo ew_CurrentPage() ?>" method="post" onsubmit="return searchengine_edit.ValidateForm(this);">
<p>
<input type="hidden" name="a_table" id="a_table" value="searchengine">
...
<?php if ($searchengine->id->Visible) { // id ?>
	<tr<?php echo $searchengine->id->RowAttributes ?>>
		...
		<td<?php echo $searchengine->id->CellAttributes() ?>><span id="el_id">
<div<?php echo $searchengine->id->ViewAttributes() ?>><?php echo $searchengine->id->EditValue ?></div><input type="hidden" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($searchengine->id->CurrentValue) ?>">
</span><?php echo $searchengine->id->CustomMsg ?></td>
	</tr>
<?php } ?>
...
<?php
$searchengine_edit->Page_Terminate();
?>
<?php
...
class csearchengine_edit {
	...
	// Page Object Name
	var $PageObjName = 'searchengine_edit';
	...
	function Page_Main() {
		...
		if (@$_POST["a_edit"] <> "") {
			$searchengine->CurrentAction = $_POST["a_edit"]; // Get action code
			$this->LoadFormValues(); // Get form values

			// Validate Form
			if (!$this->ValidateForm()) {
				$searchengine->CurrentAction = ""; // Form error, reset action
				$this->setMessage($gsFormError);
				$this->RestoreFormValues();
			}
		} else {
			$searchengine->CurrentAction = "I"; // Default action is display
		}

		// Check if valid key
		if ($searchengine->id->CurrentValue == "")
			$this->Page_Terminate("searchenginelist.php"); // Invalid key, return to list
		...
		// Render the record
		$searchengine->RowType = EW_ROWTYPE_EDIT; // Render as edit
		$this->RenderRow();
	}
