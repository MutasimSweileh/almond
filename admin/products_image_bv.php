...
// Define page object
$products_image_blobview = new cproducts_image_blobview();
$Page =& $products_image_blobview;

// Page init processing
$products_image_blobview->Page_Init();

// Page main processing
$products_image_blobview->Page_Main();
?>
<?php
$products_image_blobview->Page_Terminate();
?>
<?php
...
// Page Class
//
class cproducts_image_blobview {

	// Page ID
	var $PageID = 'blobview';

	// Page Object Name
	var $PageObjName = 'products_image_blobview';
	...
	//  - open connection
	//
	function cproducts_image_blobview() {
		global $conn;
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('products', 'x_image');
